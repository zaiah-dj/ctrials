...
//Quick way to create new elements...?
function createElement (obj) {
	...
	for ( key in obj ) {
		...
		//the safest way to do this is to query the available 
		//DOM methods via something like 'select $key from $dom'
		//
		//a super crude way to do it is create an array (or object)
		//and find the element within
		//
		//at the end, need to add any listeners
	}
	return node;	
}
