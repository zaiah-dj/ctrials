/*EE n1*/	
INSERT INTO [zProgrammer_AntonioCollins].[dbo].[frm_EETL]([insertedBy], [dayofwk], [stdywk], [typedata], [weight], [participantGUID], [d_visit], [staffID], [mchntype])
...
/*
INSERT INTO [zProgrammer_AntonioCollins].[dbo].[frm_EETL]([insertedBy], [dayofwk], [stdywk], [typedata], [weight], [participantGUID], [d_visit], [staffID], [mchntype])
VALUES(1049, 5, 1, 1, 180, '96EAB663-6804-4624-88AB-720D71C602E0', '2018-08-10', '1049', 1);

INSERT INTO [zProgrammer_AntonioCollins].[dbo].[frm_RETL]([insertedBy], [dayofwk], [stdywk], [typedata], [weight], [participantGUID], [d_visit], [staffID], [bodypart])
VALUES(1049, 5, 1, 1, 180, '6AD200F6-BF4F-4C83-8893-0A6CBDB9FB9F', '2018-08-10', '1049', 1);
*/
...
SELECT TOP (1000)
      ...
      ,[participantGUID]
      ,[d_visit]
  FROM [zProgrammer_AntonioCollins].[dbo].[frm_EETL];
...
SELECT TOP (1000)
      ...
      ,[participantGUID]
      ,[d_visit]
  FROM [zProgrammer_AntonioCollins].[dbo].[frm_RETL];
 */